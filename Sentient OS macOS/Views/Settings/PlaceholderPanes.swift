...
//  future form so the window feels whole and the design is judgeable now. Down to ONE resident
//  (Proactive & Sidekick); this file dies when ProactivePane lands for real.
//
