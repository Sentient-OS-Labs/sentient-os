...
| `Ingestion/` | The reading pipeline: `Connector` protocol + `ItemKey` + `IterativeRun` + `CycleStore` (crash-safe core), the per-source connectors (`Connectors/`), `PipelineActivity`, `FactoryReset` | `Iterative Core (Connectors).md` |
